 ...
 * 
 */
public class SensorGetMagneticField extends SensorGet {
	...
	void registerListener() {
		...
		if (deviceSensors != null && deviceSensors.size() > 0) {
			...
			mSensorManager.registerListener(this,
					...
					PropertyHolder.sensorDelayMAGNETIC_FIELD());
		}
	}
